...
export const commandBot = new CommandBot({
  appId: process.env.BOT_ID,
  appPassword: process.env.BOT_PASSWORD,
  commands: [ new HelloWorldCommandHandler(), new HelpCommandHandler() ]
});

// commandBot.registerCommands([ new HelloWorldCommandHandler(), new HelpCommandHandler() ]);
