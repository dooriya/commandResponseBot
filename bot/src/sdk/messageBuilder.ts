import { Activity, Attachment, CardAction, CardFactory, CardImage, HeroCard, O365ConnectorCard, ReceiptCard, ThumbnailCard } from "botbuilder";
...
export class MessageBuilder {
     ...
     */
    public static attachedAdaptiveCard<TData>(getCardData: () => TData, cardTemplate: any): Partial<Activity> {
    ...
    public static AttachSigninCard(
